addLayer("spaceZone2", {
    ...
    startData() { return {
        ...
        levelScaling: new Decimal(1.125),
            ...
            ["style-row", [
                ["style-column", [
                    ...
                    ["top-column", [
                        ...
                        ["raw-html", () => {return Decimal.sub(1.125, player.ir.levelScalingReduction).gt(1) ? "<u>Level Scaling" : ""}, {color: "white", fontSize: "20px", fontFamily: "monospace"}],
                        ["raw-html", () => {return Decimal.sub(1.125, player.ir.levelScalingReduction).gt(1) ? formatSimple(Decimal.sub(1.125, player.ir.levelScalingReduction).max(1).sub(1).mul(100)) + "% starting at 20" : ""}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
                        ["blank", "10px"],
