...
addLayer("stagnantSynestia", {
    ...
    nodeStyle() {
        let str = {
            background: "radial-gradient(#094394, #053a54)",
    ...
    clickables: {
        "enter": {
            ...
            style: {width: "200px", minHeight: "75px", color: "white", background: "radial-gradient(#094394, #053a54)", border: "3px solid #021924", borderRadius: "20px", textShadow: "1px 1px 1px black, -1px 1px 1px black, -1px -1px 1px black, 1px -1px 1px black, 0px 0px 3px black"},
        },
        "neg": {
            title: "Swap Sides",
            canClick: true,
...
BHC.staticAlpha = {
    ...
    symbol: "⧖α",
    style: {
        background: "linear-gradient(45deg, #094394, #053a54)",
        color: "#0091DC",
        borderColor: "#021924",
    },
