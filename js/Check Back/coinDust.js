addLayer("ev0", {
    ...
    update(delta) {
        ...
        player.ev0.coinDustPerSecond = player.ev0.coinDustPerSecond.mul(player.ev13.diamondDustEffect)
        if (hasUpgrade("ev13", 11)) player.ev0.coinDustPerSecond = player.ev0.coinDustPerSecond.mul(20)
