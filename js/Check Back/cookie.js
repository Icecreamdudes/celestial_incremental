            ...
            "Regular Buildings": {
                content: [
                    ...
                    ["always-scroll-column", [
                        ...
                        ["style-row", [
                            ["raw-html", () => {return "Next building unlocked at Pet Level " + formatWhole(Decimal.sub(getLevelableAmount("pet", 403).div(5).add(0.01).ceil().mul(5), getLevelableAmount("pet", 403)))}, {color: "#ccc", fontSize: "13px", textShadow: "0px 1px 0px #000,0px 0px 1px #ccc"}],
