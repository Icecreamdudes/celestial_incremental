    ...
    clickables: {
        ...
        14: {
            ...
            canClick() { return player.ep1.gold.gte(1e5) && (
                getLevelableTier("spet", 101).gte(1)
                || getLevelableTier("spet", 102).gte(1)
                || getLevelableTier("spet", 103).gte(1)
                || getLevelableTier("spet", 104).gte(1)
                || getLevelableTier("spet", 105).gte(1)
                || getLevelableTier("spet", 106).gte(1)
                || getLevelableTier("spet", 107).gte(1)
                || getLevelableTier("spet", 108).gte(1)
                || getLevelableTier("spet", 109).gte(1)
                || getLevelableTier("spet", 110).gte(1)
                ||getLevelableTier("spet", 201).gte(1)
                || getLevelableTier("spet", 202).gte(1)
                || getLevelableTier("spet", 203).gte(1)
                || getLevelableTier("spet", 204).gte(1)
                || getLevelableTier("spet", 205).gte(1)
                || getLevelableTier("spet", 206).gte(1)
                || getLevelableTier("spet", 207).gte(1)
                || getLevelableTier("spet", 208).gte(1)
                || getLevelableTier("spet", 209).gte(1)
                || getLevelableTier("spet", 210).gte(1)
            )},
