addLayer("hpw", {
    ...
    update(delta) {
        ...
        if (player.hpw.powerGain.gte(2.8e7)) player.hpw.powerGain = Decimal.pow(2, player.hbl.blessings.add(1).div(6e5).log(6)).add(5.6)
    ...
    tabFormat: [
        ...
        ["tooltip-row", [
            ...
            ["raw-html", () => {return player.hpw.powerGain.gte(2.8e7) ? "<small style='margin-left:10px'>[SOFTCAPPED]</small>" : ""}, {color: "red", fontSize: "20px", fontFamily: "monospace"}],
            ["raw-html", () => {return player.hpw.powerGain.gte(2.8e7) ? "<div class='bottomTooltip'>Base Formula<hr><small>2^(log6(Blessings/600k))+5.6</small></div>" : "<div class='bottomTooltip'>Base Formula<hr><small>(Blessings/600k)^0.6</small></div>"}],
        ]],
        ["blank", "10px"],
        ["clickable", 1],
        ["blank", "5px"],
