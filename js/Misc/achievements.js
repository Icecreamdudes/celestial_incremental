addLayer("achievements", {
    ...
    achievements: {
        ...
        1203: {
            ...
            tooltip: "<h3>α Thousand of Them</h3><hr style='margin-bottom:4px'>Reach the ↻ effect softcap.",
            color: "#994d99",
        ...
        1204: {
            ...
            tooltip: "<h3>Time Attack</h3><hr style='margin-bottom:4px'>Store a time capsule.",
            color: "#994d99",
        ...
        1205: {
            ...
            tooltip: "<h3>The Deep End</h3><hr style='margin-bottom:4px'>Obtain a γ ↻.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1206: {
            ...
            tooltip: "<h3>Every Last Drop</h3><hr style='margin-bottom:4px'>Store at least 5 time capsules<br>at once.<br><br>Reward: +1 base time capsules<br>stored.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
            marked: true,
        ...
        1208: {
            ...
            tooltip: "<h3>Taking Shape</h3><hr style='margin-bottom:4px'>Get at least 1 ↻ for each<br>of the first three pyramid<br>fountains.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1209: {
            ...
            tooltip: "<h3>triangle</h3><hr style='margin-bottom:4px'>Get at least 1 ↻ for each<br>of the first six pyramid<br>fountains.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1210: {
            name: "Speed Limit",
            image: "resources/achievements/12_00.png",
            tooltip: "<h3>Speed Limit</h3><hr style='margin-bottom:4px'>Exceed x100 Light Well<br>Speed.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1211: {
            ...
            tooltip: "<h3>Faster than Light</h3><hr style='margin-bottom:4px'>Blueshift a light well.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        ...
        1213: {
            ...
            tooltip: "<h3>Midnight Zone</h3><hr style='margin-bottom:4px'>Obtain a δ ↻.",
            color: "#994d99",
            complete() {return player.wel.modules[4].completions.gt(0)},
            unlocked: true,
        },
        1214: {
            name: "First Wonder of The Universe",
            image: "resources/achievements/12_00.png",
            tooltip: "<h3>First Wonder of The<br>Universe</h3><hr style='margin-bottom:4px'>Get at least 1 ↻ for each<br>of the first ten pyramid<br>fountains.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1215: {
            ...
            tooltip: "<h3>Extreme Speed</h3><hr style='margin-bottom:4px'>Store at least 10,000 time<br>capsules at once.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        ...
        1217: {
            ...
            tooltip: "<h3>awwww kitty!!!</h3><hr style='margin-bottom:4px'>Unlock goobert.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1218: {
            ...
            image: "resources/achievements/12_00.png",
            tooltip: "<h3>okay this is getting ridiculous</h3><hr style='margin-bottom:4px'>Get at least 1 ↻ for each<br>of the first thirteen pyramid<br>fountains.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1219: {
            name: "Outerspace",
            image: "resources/achievements/12_00.png",
            tooltip: "<h3>Outerspace</h3><hr style='margin-bottom:4px'>Enter space zone IV.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        ...
        1221: {
            ...
            tooltip: "<h3>I guess we're doin' glass<br>now</h3><hr style='margin-bottom:4px'>Obtain a ε ↻.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1222: {
            ...
            image: "resources/achievements/12_00.png",
            tooltip: "<h3>Reflecting Pool</h3><hr style='margin-bottom:4px'>Get at least 1 ↻ for every<br>pyramid fountain.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
        1223: {
            ...
            tooltip: "<h3>I sure hope I keep this<br>a while</h3><hr style='margin-bottom:4px'>Obtain a θ ↻.",
            color: "#994d99",
            complete() {return false},
            unlocked: true,
        },
