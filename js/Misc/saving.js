addLayer("saving", {
  name: "Saving", // This is optional, only used in a few places, If absent it just uses the layer id.
  ...
  clickables: {
    ...
    11: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Info";
      },
      style: {
        width: "100px",
        minHeight: "50px",
    ...
    12: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Start-Checkback";
      },
      style: {
        width: "125px",
        minHeight: "50px",
    ...
    13: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Checkback-Infinity";
      },
      style: {
        width: "125px",
        minHeight: "50px",
    ...
    14: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Infinity-Tav";
      },
      style: {
        width: "125px",
        minHeight: "50px",
        color: "rgba(0,0,0,0.8)",
        background:
          "linear-gradient(315deg, rgba(211,161,101,1) 0%, #FFBF00 100%)",
        borderRadius: "0px",
        border: "2px solid white",
      },
    },
    15: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Tav-BreakInfinity";
      },
      style: {
        width: "150px",
        minHeight: "50px",
    ...
    16: {
      title() {
        return "Break Infinity<br>Cante";
      },
      canClick() {
        return true;
      },
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "BreakInfinity-Cante";
      },
      style: {
        width: "150px",
        minHeight: "50px",
    ...
    17: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Cante-Singularity";
      },
      style: {
        width: "125px",
        minHeight: "50px",
    ...
    18: {
      title() {
        return "Singularity<br>Starmetal";
      },
      canClick() {
        return true;
      },
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Singularity-Starmetal";
      },
      style: {
        width: "125px",
        minHeight: "50px",
        color: "rgba(0,0,0,0.8)",
        background: "linear-gradient(140deg, red 0%, black 120%)",
        borderRadius: "0px",
        border: "2px solid white",
      },
    },
    19: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Starmetal-Matos";
      },
      style: {
        width: "125px",
        minHeight: "50px",
    ...
    21: {
      ...
      onClick() {
        player.subtabs["saving"]["stuff"] = "Matos-End";
      },
      style: {
        width: "125px",
        minHeight: "50px",
        color: "black",
        background:
          "linear-gradient(120deg,rgb(138, 14, 121) 0%,rgb(168, 12, 51) 100%)",
        borderRadius: "0px",
        border: "2px solid white",
      },
    },
    ...
    stuff: {
      Info: {
        ...
        content: [
          ...
          [
            "raw-html",
            "The savebank allows you to load a save from any part of the game.<br>",
            { color: "white", "font-size": "16px", "font-family": "monospace" },
          ],
          ["blank", "25px"],
          [
            "raw-html",
            "WARNING: Loading a save will write over your current save.<br>Please export your current save before messing with the savebank.",
            { color: "red", "font-size": "16px", "font-family": "monospace" },
          ],
          ["blank", "10px"],
          [
            "raw-html",
            "SPOILERS: Save names will spoil parts of the game, tread carefully.",
            { color: "red", "font-size": "16px", "font-family": "monospace" },
          ],
          ["blank", "25px"],
        ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "001 - Unlocked Prestige"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 101],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "007 - First Grasshop Reset"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 107],
                ],
            ...
            [
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "010 - Unlocked Check Back"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 110],
                ],
            ...
            [
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "012 - Reached 1e200 Points"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 202],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "013 - Reached 1e250 Points"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 203],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "014 - Reached First Infinity"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 204],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "015 - Halfway Through First Infinity"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 301],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "016 - Reached Second Infinity"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 302],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "017 - Halfway Through Second Infinity"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 303],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "018 - Reached Third Infinity"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 304],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "019 - First Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 305],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "020 - Second Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 306],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "021 - Third Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 307],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "022 - Fourth Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 308],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "023 - Fifth Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 309],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "024 - Sixth Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 310],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "025 - Seventh Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 311],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "026 - Eigth Infinity Challenge"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 312],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "027 - Some NIP Collected"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 401],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "028 - Fifth Tav NIP Upgrade"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 402],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "029 - Sixth Tav NIP Upgrade"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 403],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "030 - Seventh Tav NIP Upgrade"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 404],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "031 - Eigth Tav NIP Upgrade"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 405],
                ],
              ...
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "032 - Ninth Tav NIP Upgrade"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 406],
                ],
            ...
            [
              [
                ...
                [
                  [
                    "style-row",
                    [["raw-html", "033 - First Infinity in Tav's Domain"]],
                    { width: "296.5px", height: "50px" },
                  ],
                  ["clickable", 407],
                ],
  ...
  tabFormat: [
    ...
    [
      ...
      [
        ...
        [
          "raw-html",
          () =>
            "<button class=opt onclick=toggleOpt('autosave')>Autosave:<br>" +
            options.autosave +
            "</button>",
          { color: "white", "font-size": "18px", "font-family": "monospace" },
        ],
        [
          "raw-html",
          () =>
            "<button class=opt onclick=hardReset() style='color:darkred'>HARD RESET</button>",
          { color: "red", "font-size": "18px", "font-family": "monospace" },
        ],
      ],
    ],
    [
    ...
    [
      ...
      () => {
        if (galaxy.connected) {
          return (
            "<h3 style='color: white'>Connected to Galaxy</h3><br>" +
            galaxy.message
          );
        } else {
      ...
      () => {
        if (galaxy.connected) {
          return [
            [
              "raw-html",
              "<button class=opt onclick=galaxy.sendSave()>Save</button>",
              {
                color: "white",
                "font-size": "18px",
                "font-family": "monospace",
            ...
            [
              "raw-html",
              "<button class=opt onclick=galaxy.requestSave()>Load</button>",
              {
                color: "white",
                "font-size": "18px",
                "font-family": "monospace",
            ...
            [
              "raw-html",
              "<button class=opt onclick=toggleOpt('cloudSave')>Autosave:<br>" +
                options.cloudSave +
                "</button>",
              {
                color: "white",
            ...
            [
              "raw-html",
              "<button class=opt onclick=incrementSlotNumber()>Slot:" +
                options.cloudSaveSlot +
                "</button>",
              {
                color: "white",
                "font-size": "18px",
    ...
    ["blank", "10px"],
    ["raw-html", "<h1 style='color: white'>SaveBank</h1>"],
      ...
      [
        [
          ...
          ],
          {
            width: "800px",
            background:
              "repeating-linear-gradient(-45deg, #161616 0 15px, #101010 0 30px)",
          },
        ],
