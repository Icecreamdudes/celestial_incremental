addLayer("lightRift", {
    ...
    clickables: {
        ...
        103: {
            ...
            canClick() { return player.au2.stars.gte(1e32) && !player.lightRift.interspaceConditions[2] },
            unlocked() { return true },
            onClick() {
                    ...
                    ["style-column", [
                        ...
                        ["style-row", [
                            ["style-column", [
                                ...
                                ["style-row", [
                                    ["raw-html", () => {return format(player.au2.stars) + " / 1e32<br>Stars"}, {color: "white", fontSize: "16px", fontFamily: "monospace"}],
                                ], {background: "#1a6641", borderRadius: "10px 10px 0px 0px", width: "250px", height:"50px"}],
                                ["blank", "3px", {width: "3px"}],
                                ["clickable", 103],
