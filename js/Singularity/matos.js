    ...
    microtabs: {
             ...
             "Perks": {
                ...
                ["style-column", [
                    ...
                    ["blank", "25px"],
                            ...
                            ["raw-html", function () { return "x1e20 to golden grass." }, { "color": "white", "font-size": "18px", "font-family": "monospace" }],
        ...
        ["raw-html", function () { return "Now. We must determine if you are truly ready or not." }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
                    ...
                    ["row", [
                        ...
                        ["column", [
    ["raw-html", function () { 
        return player.pet.levelables[501][0].gte(1) 
            ? "Eclipse" 
            : ""; 
    }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
    ["raw-html", function () { 
        return player.pet.levelables[501][0].gte(1) 
            ? "Max Health: <h3>" + format(player.ma.healthMax[3]) + " " 
            : ""; 
    }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
    ["raw-html", function () { 
        return player.pet.levelables[501][0].gte(1) 
            ? "Average Damage: <h3>" + format(player.ma.damage[3]) + " " 
            : ""; 
    }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
    ["raw-html", function () { 
        return player.pet.levelables[501][0].gte(1) 
            ? "Attack Cooldown: <h3>" + formatTime(player.ma.cooldown[3]) + " " 
            : ""; 
    }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
                            ["raw-html", function () { return hasUpgrade("ma", 28) && player.pet.levelables[501][0].gte(1) ? "Health Regen: <h3>" + format(player.ma.healthRegen[3]) + "/s" : "" }, { "color": "white", "font-size": "24px", "font-family": "monospace" }],
                            ["clickable", 19],
