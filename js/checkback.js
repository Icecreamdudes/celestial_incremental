...
addLayer("cb", {
    ...
    update(delta) {
        ...
        if (hasAchievement("achievements", 1014)) player.sm.totalChipMult = player.sm.totalChipMult.mul(1.1)
        if (hasAchievement("achievements", 1015)) player.sm.totalChipMult = player.sm.totalChipMult.mul(1.1)
