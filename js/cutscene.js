-addLayer("c", {
 ...
 /*       "U2-Tav-End": {
        ...
        "UD-Start": {
            ...
            dialogue: [
                { text: "The rift glows a brilliant white. It's open now." },
                { text: "." },

                { text: "I'm Bumpy, the sole developer and ruler of the Interspace city.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "I control everything, from .", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "You can do that all by yourself?", portrait: "resources/player.png"},
            ],
        },
        "UD-Light-Well-Alpha": {
            type: "normal",
        ...
        "D1-Time-Capsules": {
            ...
            portrait: "resources/secret.png",
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, black 0%, #2e152e 100%)",
        ...
        "UD-Project-1-2": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #2e152e 0%, #384038 100%)",
            trigger() {return player.prj.modules[1].focused == true && player.prj.modules[1].completions.gte(1) },
            dialogue: [
        ...
        "UD-Light-Well-Gamma": {
            ...
            dialogue: [
                ...
                { text: "Gah. Do you happen to know much about machinery?", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "I literally killed the Celestial of Machinery, but no, not really.", portrait: "resources/player.png" },
            ],
        },
        "UD-Project-1-5": {
            type: "normal",
            ...
            dialogue: [
                { text: "You begin to get the hang of operating multiple bodies at once." },
                { text: "Though, working on these projects takes a lot out of you." },
                { text: "You almost don't notice Bumpy walk into the room before he starts talking." },
                { text: "I'm impressed you're picking these up so quickly.", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ],
        },
        "UD-Project-2-1": {
            type: "normal",
        ...
        "UD-Prismatic-Reset": {
            ...
            dialogue: [
                ...
                { text: "Yes! I've never been more excited for anything in my life!", portrait: "resources/characterPortraits/reese/happy.png" },
                { text: "Finally, we'll have a place to ourselves...", portrait: "resources/characterPortraits/auroraHuman/hooded/smile.png" },
                { text: "These must be the founders Bumpy was referring to." },
                { text: "Bumpy and the winged boy stretch their arms out to the orb, while the cloaked person shyly watches." },
                { text: "The orb expands rapidly, forming a dark green sky and pale grass." },
                { text: "Ah. This is exactly as I envisioned it. Good job you two.", portrait: "resources/characterPortraits/auroraHuman/hooded/happy.png" },
                { text: "I'm glad I was able to get a hold of that grass...", portrait: "resources/characterPortraits/bumpy/sad.png" },
                { text: "Oooooh, the sky is so pretty!", portrait: "resources/characterPortraits/reese/frown.png" },
            ],
        },
        "UD-Pyramid-Row-2": {
            type: "normal",
        ...
        "UD-Blueshift-Project-Start": {
            ...
            dialogue: [
                ...
                { text: "What do you think? Should I go with maroon and mint, or plum and cream?", portrait: "resources/memoryBumpy.png" },
                { text: "Hmmm... I like maroon and mint! It matches you!", portrait: "resources/humanCere.png" },
                { text: "Yeah... but Aurora's in on this, too. I don't want to flaunt my theme to-", portrait: "resources/memoryBumpy.png" },
                ...
                { text: "I-I-Is that a...!?", portrait: "resources/memoryBumpy.png" },
        ...
        "UD-Light-Well-Delta": {
            ...
            dialogue: [
                { text: "The fourth well lights up at last."},
        ...
        "UD-Starlight-Project-Start": {
            ...
            dialogue: [
                ...
                { text: "That must be Taro."},
                { text: "The sky lights up a dim green that shifts to bright pink."},
                { text: "Countless beams of pink light fill the sky; a few begin to angle in on Taro's street."},
                { text: "I'll spare your village if you come out now.", portrait: "resources/cere.png" },
                { text: "A man with pale green hair and two sets of black wings flies just above the crowd."},
                ...
                { text: "Cere! CERE! Stop this now!", portrait: "resources/memoryBumpy.png" },
                { text: "Bumpy..." },
                ...
                { text: "Hey!", portrait: "resources/memoryBumpy.png" },
                { text: "The two dive toward Taro and hit each other on the way."},
                { text: "Let me go!", portrait: "resources/cere.png" },
