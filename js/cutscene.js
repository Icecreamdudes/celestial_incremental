-addLayer("c", {
 ...
 /*       "U2-Tav-End": {
        ...
        "U3-LightRift": {
            ...
            background: "#260300",
            music: "music/singularityWaltzPiano.mp3",
            trigger() {return false && player.tab == "lightRift" },
            dialogue: [ 
        ...
        "UD-Start": {
            ...
            trigger() {return false && player.lightRift.interspaceUnlocked },
            dialogue: [ 
                ...
                { text: "It highkey is.", portrait: "resources/player.png"  },
                { text: "I'd hope so, now c'mon, we got work to do.", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ]
        },
        "CH-Multiverse-Map": {
            type: "normal",
            portrait: "resources/secret.png",
            trigger() {return false && player.tab == "mm" },
            dialogue: [
                { text: "You hold the device into the air." },
                { text: "The deep blue sky melts to reveal millions of dots of light. Each one is an individual universe." },
        ...
        "UD-Light-Well-Alpha": {
            type: "normal",
            portrait: "resources/secret.png",
            trigger() {return false && hasUpgrade("wel", 11)},
            dialogue: [
        ...
        "UD-Light-Well-Beta": {
            type: "normal",
            portrait: "resources/secret.png",
            trigger() {return false && player.wel.modules[1].completions.gte(50) },
            dialogue: [
        ...
        "UD-Projects-Unlocked": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(-135deg, #804080 0%, #608060 100%)",
            trigger() {return false && player.tab == "prj" && false },
            dialogue: [
                { text: "Bumpy walks over to you." },
                { text: "It's about time for some ", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Clones?", portrait: "resources/player.png" },
                { text: "YES! And some other stuff, but clones first.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Brace yourself.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "The floor begins to descend." },
                { text: "Haha I am the creation and I am green.", portrait: "resources/greenCreation.png" },
            ],
        },
        "D1-Time-Capsules": {
            type: "normal",
            portrait: "resources/secret.png",
            trigger() {return false && player.dt.timeCapsules.gt(0)},
            dialogue: [
        ...
        "UD-Project-1-2": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(-135deg, #804080 0%, #608060 100%)",
            trigger() {return false && player.prj.modules[1].focused == true && player.prj.modules[1].completions.gte(1) && false },
            dialogue: [
                { text: "You return to the pyramid with a time capsule." },
                { text: "I'm ready.", portrait: "resources/player.png" },
                
                // ???

                { text: "Bumpy kneels next to you holding a reflective prism." },
                { text: "I didn't expect you to pass out like that. Are you okay?", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Holy crap, I'm green!", portrait: "resources/greenCreation.png" },
                { text: "Yes, you're green! Do you know what green means?", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Green means clean! I mean clone!", portrait: "resources/greenCreation.png" },
                { text: "Good enough. Gotta make sure your head's still intact after that fall.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Your main body lays limp on the ground beside you, in only a small puddle of blood." },
                { text: "So how do I- I guess multitask?", portrait: "resources/greenCreation.png" },
                { text: "Multitask on what? Define the question, then the answer!", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "You don't need to think that hard for this: gathering light!" },
                { text: "You walk over to your main body, and pull them off the ground." },
                { text: "You've never had a good look at yourself until now." },
                { text: "Messy black hair, not super tall, wearing a cloak-like garment over your upper torso and back." },
                { text: "And that little symbol on your cloak... the symbol of-" },
                { text: "You represent humanity. You're a glimmer of hope. A light in the dark.", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ],
        },
        "UD-Light-Well-Gamma": {
            type: "normal",
            portrait: "resources/secret.png",
            trigger() {return false && player.wel.modules[2].completions.gte(500) && false },
            dialogue: [
                ...
                { text: "Yeah, this well's broken, and the liquid flows too high up.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Bumpy scrambles to find something in his bag." },
                { text: "Some days, it does this. Others, it won't work at all. And I can't fix it!", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "You see, these wells were not built by me, but one of my co-founders.", portrait: "resources/characterPortraits/bumpy/smile.png" },
        ...
        "UD-Project-1-5": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(-135deg, #804080 0%, #608060 100%)",
            trigger() {return false && hasMilestone("prj", 105) && false },
            dialogue: [
        ...
        "UD-Project-2-1": {
            ...
            trigger() {return false && player.prj.modules[2].focused == true },
            dialogue: [
                { text: "UD-Project-2-1." },
            ],
        },
        "UD-Prismatic-Reset": {
            ...
            background: "linear-gradient(-135deg, #bf8fbf 0%, #b4bfb4 100%)",
            trigger() {return false && player.pri.totalPrisms.gt(0) },
            dialogue: [
        ...
        "UD-Project-2-2": {
            ...
            portrait: "resources/secret.png",
            background: "linear-gradient(-135deg, #bf8fbf 0%, #b4bfb4 100%)",
            trigger() {return false && player.prj.modules[2].focused == true && hasMilestone("prj", 201) },
            dialogue: [
        ...
        "UD-Blueshift-Project-Start": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(-135deg, #bf8fbf 0%, #b4bfb4 100%)",
            trigger() {return false && hasMilestone("prj", 301) && false },
            dialogue: [
        ...
        "UD-Light-Well-Delta": {
            ...
            trigger() {return false && hasMilestone("prj", 303) && player.wel.modules[3].completions.gte(1e12) }, //hasMilestone("prj", 303) },
            dialogue: [
                { text: "The fourth well lights up again, but green this time."},
                { text: "At last!", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "That took forever.", portrait: "resources/player.png" },
                { text: "This well is a bit different than the others.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "It was the first well built, and feeds directly into the greenhouse.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "That's where you were first experimenting with prisms...", portrait: "resources/player.png" },
                { text: "Yes! How'd you know?", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Ummm... context clues. I'm learning a lot about this place.", portrait: "resources/player.png" },
            ],
        },
        "UD-Light-Well-Delta-Blueshift": {
            type: "normal",
            portrait: "resources/secret.png",
            trigger() {return false && false },
            dialogue: [
                { text: "You're almost ready for your final project. Unfortunately, this well won't be.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "What's it going to take after this, an hour at least??", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ],
        },
        "UD-Starlight-Project-Start": {
            ...
            portrait: "resources/secret.png",
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #bf8fa7 0%, #a8bfbf 100%)",
            trigger() {return false && player.prj.modules[4].focused == true && false },
            dialogue: [
                { text: "You enter a flashback."},
                { text: "A crowd is running through a narrow street, likely fleeing from something."},
                { text: "A man in vibrant blue armor is pushing himself through especially fast."},
                { text: "It's Taro."},
                { text: "The sky lights up a dim green, then shifts to bright pink."},
                { text: "Countless pink lasers fill the sky; a few begin to angle in on Taro's street."},
                { text: "I'll spare your village if you come out now.", portrait: "resources/cere.png" },
                { text: "A man with pale pink hair and two sets of black wings flies just above the crowd."},
                { text: "The beams cross the ground around him, obliterating every building in their path."},
                { text: "I don't want to make this more difficult than it needs to be.", portrait: "resources/cere.png" },
                { text: "A single green beam of light strikes the winged man from the top of an intact wall."},
                { text: "Gah! But I'll destroy this whole planet if I need to!", portrait: "resources/cere.png" },
                { text: "Cere! CERE! Stop this now!", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Bumpy..." },
                { text: "I'll kill you, too. She'll really love your soul!", portrait: "resources/cere.png" },
                { text: "Cere spots Taro deviating from the group to run into an intact building."},
                { text: "Cere dives toward Taro, interrupted by a tackle from Bumpy."},
                { text: "Get off of me!", portrait: "resources/cere.png" },
                { text: "I'm never letting you and Aurora reach that boy.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "You're a traitor, Bumpy.", portrait: "resources/cere.png" },
                { text: "I'm the only one of us who hasn't lost their gwadamned mind.", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ],
        },
