-addLayer("c", {
 ...
 /*       "U2-Tav-End": {
        ...
        "U3-Light-Rift": {
            ...
            dialogue: [
                { text: "You hear a buzzing from a nearby device."},
                { text: "Mr. Foresight! My radio is picking up a signal!", portrait: "resources/kres.png"},
                { text: "Kres adjusts a knob on the radio for few seconds while looking at it annoyedly."},
                { text: "It sounds like garbage noise...", portrait: "resources/player.png"},
                { text: "I might know why... our radios have a feature we've never had a use for, but you might.", portrait: "resources/kres.png"},
                { text: "They can transmit superphysical messages solely for specific foresight users that can wield their superphysical value.", portrait: "resources/kres.png"},
                { text: "You should take a listen, it might be for you.", portrait: "resources/kres.png"},
                { text: "I can try.", portrait: "resources/player.png"},
                { text: "Kres hands you the radio. You certainly feel a superphysical presence."},
                { text: "It's unfamiliar, but very coherent."},
                { text: "Technological... stars... singularities... space energy..."},
                { text: "You see something else. It looks like a map of a city."},
                { text: "Is anything getting through?", portrait: "resources/kres.png"},
                { text: "It's a set of instructions. It wants me to open a rift.", portrait: "resources/player.png"},
                { text: "And there's a map of a city, too.", portrait: "resources/player.png"},
                { text: "Cool. Welp, I guess this is a you thing. Good luck.", portrait: "resources/kres.png"},
            ],
        },
        "UD-Start": {
            type: "normal",
            ...
            dialogue: [
                { text: "With the power of these four superphysical values, a new message can be heard..."},
                { text: "THE CYCLE MUST BREAK."},
                { text: "Weird."},
                ...
                { text: "You marvel at the masterpiece of a civilization. It's the first one you've seen in person, and it's beautiful." },
                { text: "You notice that something has made it's way into your pocket: a small machine covered in buttons." },
                { text: "You hold it up, and it projects a hologram into the air: a web of colorful orbs and symbols." },
                { text: "One, two, alpha, A-one, three... they all represent universes. Is this a map of the Dimensional Realm?" },
                { text: "One universe stands out as one you've yet to explore, and is highlighted." },
                { text: "Universe delta: Interspace." },
                { text: "The orb expands into a line, showing what appears to be your location on one end, and a \"plaza\" on the other." },
                { text: "The plaza must be your destination." },
                { text: "You must be the Creation.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Yup, and you?", portrait: "resources/player.png"},
                { text: "I'm Bumpy, the developer in charge of maintaining this city.", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ],
        },
        "CH-Multiverse-Map": {
            type: "normal",
            ...
            dialogue: [
                ...
                { text: "That must be the dark energy. No wonder it's such a big deal." },
        ...
        "UD-Light-Well-Alpha": {
            ...
            dialogue: [
                ...
                { text: "Use this to pull liquid light from the wells.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Pour it into fountains to harness its energy.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                ...
                { text: "I promise, it'll pay off later.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Take as many breaks as you need.", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ],
        },
        "UD-Light-Well-Beta": {
            type: "normal",
            ...
            dialogue: [
                ...
                { text: "I don't know what I could have expected really. Foresight is weird.", portrait: "resources/player.png" },
        ...
        "D1-Time-Capsules": {
            type: "normal",
            portrait: "resources/secret.png",
            trigger() {return player.dt.timeCapsules.gt(0) && false},
            dialogue: [
        ...
        "UD-Project-1-2": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #2e152e 0%, #384038 100%)",
            trigger() {return player.prj.modules[1].focused == true && player.prj.modules[1].completions.gte(1) && false },
            dialogue: [
        ...
        "UD-Project-1-5": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #2e152e 0%, #384038 100%)",
            trigger() {return hasMilestone("prj", 105) && false },
            dialogue: [
        ...
        "UD-Prismatic-Reset": {
            ...
            background: "linear-gradient(135deg, #bf8fbf 0%, #b4bfb4 100%)",
            trigger() {return player.pri.totalPrisms.gt(0) && false },
            dialogue: [
                { text: "You enter a flashback." },
                { text: "You see three people in a triangle formation. They're gathered around a floating ball of light." },
                ...
                { text: "The founders must be hella important. So, what happened to them? You need to know." },
            ],
        },
        "UD-Pyramid-Row-2": {
            type: "normal",
            ...
            music: "music/devFlashback.mp3",
            background: "linear-gradient(135deg, #bf8fbf 0%, #b4bfb4 100%)",
            trigger() {return player.pri.fountains[2].completions.gt(0) && player.pri.fountains[3].completions.gt(0) && false },
            dialogue: [
                { text: "You enter a flashback." },
                ...
                { text: "They succeeded so wonderfully, what went wrong?" },
            ],
        },
        "UD-Project-2-2": {
            type: "normal",
        ...
        "UD-Pyramid-Row-3": {
            ...
            portrait: "resources/secret.png",
            music: "music/devFlashback.mp3",
            background: "linear-gradient(135deg, #2e1723 0%, #304040 100%)",
            ...
            dialogue: [
                { text: "You enter a flashback." },
                { text: "You see the starry Interspace sky through the ceiling of an observatory." },
                { text: "Several clones of Bumpy are scrambling around while the third founder waits impatiently." },
                { text: "Almost done, Aurora, almost done...", portrait: "resources/characterPortraits/bumpy/clone/smile.png" },
                { text: "Alright. Tell Reese to start the countdown.", portrait: "resources/characterPortraits/aurora/smile.png" },
                { text: "Reese! We're ready!", portrait: "resources/characterPortraits/bumpy/clone/smile.png" },
                { text: "Wrong clone, silly. Up there.", portrait: "resources/characterPortraits/aurora/smile.png" },
                { text: "Sorry, I'm still getting used to this.", portrait: "resources/characterPortraits/bumpy/clone/smile.png" },
                { text: "." },
            ],
        },
        "UD-Blueshift-Project-Start": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #bf8fbf 0%, #b4bfb4 100%)",
            trigger() {return hasMilestone("prj", 301) && false },
            dialogue: [
                { text: "You pick up on a superphysical presence." },
                { text: "It's coming from a book a few tables down." },
                { text: "You open it. Memories rush into your head in an unfamiliar way." },
                { text: "Two dudes in green capes sit next to each other. One holds up a glass prism and the other wields dual pencils." },
                { text: "What do you think? Should I go with maroon and mint, or plum and cream?", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Hmmm... I like maroon and mint! It matches you!", portrait: "resources/humanCere.png" },
                { text: "Yeah... but Aurora's in on this, too. I don't want to flaunt my theme to-", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "A woman in an oversized brown coat swings open the the door." },
                { text: "She holds something, but It's too bright make out what it is." },
                { text: "I-I-Is that a...!?", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Oh. Oh god. Why-", portrait: "resources/humanCere.png" },
                { text: "HIII again!", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "AHHH!! What the hell!?", portrait: "resources/player.png" },
                { text: "Ha, I'd say the same thing to you if I remembered to tell you to stay out of my stuff.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "...", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Uh, sorry. This is my journal, a place for my most dear of memories.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "One of the few things I have left for myself.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Are... you going to cry?", portrait: "resources/player.png" },
                { text: "POTENTIALLY! I haven't flipped through this thing in a while.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "There's like... some friends I lost and I don't want to-", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "I'll leave it be, Bumpy.", portrait: "resources/player.png" },
                { text: "If there's anything I can do to help, I'll be right on it.", portrait: "resources/player.png" },
                { text: "Ha... thank you.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Bumpy wipes his tears and trods out with the journal." },
                { text: "This guy seems pretty miserable here." },
                { text: "Oh well." },
            ],
        },
        "UD-Light-Well-Delta": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #2e152e 0%, #384038 100%)",
            trigger() {return hasMilestone("prj", 303) && false }, //hasMilestone("prj", 303) },
            dialogue: [
                { text: "The fourth well lights up again, but green this time."},
                { text: "This one is a bit different than the others.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "It pours into the other three, then loops back in on itself.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "It was not built by me, but by one of the other founders of Interspace.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "There were other founders?", portrait: "resources/player.png" },
                { text: "Yes. Once my two best friends.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Before we fell out, one of them added some shoddy automation all around the city.", portrait: "resources/characterPortraits/bumpy/smile.png" },
                { text: "Thank her for it if you two ever meet.", portrait: "resources/characterPortraits/bumpy/smile.png" },
            ],
        },
        ...
        "UD-Starlight-Project-Start": {
            ...
            trigger() {return player.prj.modules[4].focused == true && false },
            dialogue: [
                { text: "You enter a flashback."},
