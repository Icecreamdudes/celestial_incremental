addLayer("c", {
    ...
    cutscenes: {
        ...
        "UD-Start": {
            ...
            dialogue: [
                { text: "You follow Marcel through the portal." },
                { text: "On the other side is something extrordinarily bright. It burns your eyes." },
                { text: "AUGH!", portrait: "resources/player.png" },
                { text: "Oh yeah, I forgot about that.", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "Marcel pulls out two pairs of glasses from somewhere and hands one to you." },
                { text: "You put them on, but your eyes remain closed." },
                { text: "Welcome!", portrait: "resources/secret.png" },
                { text: "The plaza appears to be ready.", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "You hear the reply of a human above a loud fountain." },
                { text: "Yeah, I even took some spare time to decorate it.", portrait: "resources/secret.png" },
                { text: "You tilt your head into the dim-ish night sky and open your eyes." },
                { text: "The streetlights in the corners of your vision keep you blinded." },
                { text: "Hey... are you alright?", portrait: "resources/secret.png" },
                { text: "No, why is this place so bright?", portrait: "resources/player.png" },
                { text: "Good. Hi, creation! I'm Bumpy.", portrait: "resources/bumpy.png" },
                { text: "That's a funny name!", portrait: "resources/player.png" },
                { text: "It's an alias. Many developers choose to go by one, much like how you're referred to as the creation.", portrait: "resources/bumpy.png" },
                { text: "Bumpy has been readying his framework just for your usage. I'm impressed with how much he managed to get done already.", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "Yeah, ha ha...", portrait: "resources/bumpy.png" },
        ...
        "UD-ProjectsUnlocked": {
            ...
            dialogue: [
                { text: "You appear to have the hang of this!", portrait: "resources/bumpy.png" },
                { text: "Yeah. Nothing I haven't encountered before.", portrait: "resources/player.png" },
                { text: "Oh just wait my friend, you'll find some marvelous things here! Follow me!", portrait: "resources/bumpy.png" },
                { text: "Bumpy guides you out of the plaza, down one street, and into a short building." },
                { text: "You emerge from the other side on to a bridge over a wide-open warehouse." },
                { text: "Welcome to my workshop!", portrait: "resources/bumpy.png" },
                { text: "What are all those machines below?", portrait: "resources/player.png" },
                { text: "They're my projects. A lot of them are used around the city for practical purposes.", portrait: "resources/bumpy.png" },
                { text: "Light, transportation, refrigeration, stuff like that.", portrait: "resources/bumpy.png" },
                { text: "All of them run solely on superphysical energy.", portrait: "resources/bumpy.png" },
                { text: "Light… wait, I’ve used light to make starmetal alloy!", portrait: "resources/player.png" },
                { text: "You’ve made starmetal alloy??", portrait: "resources/bumpy.png" },
                { text: "Yup, I used it to empower a team to fight Matos.", portrait: "resources/player.png" },
                { text: "Amazing! Then I have just the project to start you on!", portrait: "resources/bumpy.png" },
                { text: "Bumpy walks you down a staircase in the middle of the bridge." },
                { text: "He digs into a random drawer and pulls out a sheet of paper with green text." },
                { text: "Take these instructions with you to wherever you're making that starmetal alloy.", portrait: "resources/bumpy.png" },
                { text: "Carry them out during an eclipse. Report back to me with your resulting superphysical value.", portrait: "resources/bumpy.png" },
        ...
        "D1-TimeCapsules": {
            ...
            trigger() {return player.dt.timeCapsules.gte(1) || true },
            dialogue: [
                ...
                { text: "There's surely a hand-crafted reason you feel this way." },
            ],
        },
        "UD-StoredTimeCapsule": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #2e152e 0%, #384038 100%)",
            trigger() {return player.prj.storedTimeCapsules.gte(1) },
            dialogue: [
        ...
        "UD-TimeCapsulesProjectLvl3": {
            ...
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #2e152e 0%, #384038 100%)",
            trigger() {return hasMilestone("prj", 103) },
            dialogue: [
                { text: "Got it.", portrait: "resources/player.png" },
            ],
        },
        "UD-PrismaticProjectLvl1": {
            ...
            dialogue: [
                { text: "prisms.", portrait: "resources/bumpy.png" },
            ],
        },
        "UD-BlueshiftProjectLvl1": {
            ...
            dialogue: [
                ...
                { text: "Yeah... but Aurora's in on this, too. I don't want to look too full of mys-", portrait: "resources/memoryBumpy.png" },
                ...
                { text: "Yikes.", portrait: "resources/humanCere.png" },
                ...
                { text: "Being a shoulder to lean on might make you worthy of stronger projects." },
            ],
        },
        /*
        "D1-Space-Energy": {
