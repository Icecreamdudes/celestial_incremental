    ...
    cutscenes: {
        ...
        "DS-Zar-Buyables": {
            ...
            dialogue: [
                ...
                { text: "You see what appears to be Iridite's human form, along with a man with brown hair wearing a white suit. It must be Zar's human form."  },
        ...
        "UD-Start": {
            ...
            dialogue: [
                ...
                { text: "On the other side is a bustling city. Streetlights are lit up all around you, and it appears to be nighttime." },
                { text: "Welcome to my universe.", portrait: "resources/secret.png" },
                { text: "A person with deep pink hair is looking into a fountain infront of you." },
                { text: "The plaza appear to be ready.", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "Yeah. I even took some spare time to decorate it.", portrait: "resources/secret.png" },
                { text: "And you must be the Creation.", portrait: "resources/secret.png" },
                { text: "Yep! Who are you?", portrait: "resources/player.png" },
                { text: "I am the developer of this framework, the Interspace framework.", portrait: "resources/secret.png" },
                { text: "The person grabs something out of the fountain and walks toward you. You can see him clearer now." },
                { text: "You can call me Bumpy.", portrait: "resources/bumpy.png" },
                { text: "That's a funny name!", portrait: "resources/player.png" },
                { text: "Ha, it's an alias. Developers often choose to go by one, much like how you're called the creation.", portrait: "resources/bumpy.png" },
                ...
                { text: "Around the plaza are several wells of superphysical energy.", portrait: "resources/bumpy.png" },
                { text: "They provide power to the entire city, and soon will to you, too.", portrait: "resources/bumpy.png" },
                { text: "I'm ready for it. But, why decorate it all?", portrait: "resources/player.png" },
                { text: "Some CHC people are coming down here for an employee party. I think it has something to do with you.", portrait: "resources/bumpy.png" },
                { text: "But I haven't even began my training yet?", portrait: "resources/player.png" },
                { text: "You've killed some of the strongest celestials of this part of the realm. Nothing manmade has even come close to matching your power.", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "And you will only grow stronger.", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "I'm ready for it. But, why decorate it all?", portrait: "resources/player.png" },
            ],
        },
        "UD-LightRowTwo": {
            ...
            dialogue: [
                { text: "Bumpy returns." },
                { text: "That's... a lot of light.", portrait: "resources/bumpy.png" },
                { text: "Wait- you've already found the upgrades?", portrait: "resources/bumpy.png" },
                { text: "I can sort of sense their presence.", portrait: "resources/player.png" },
                { text: "Oh yeah. I was going to tell you about them, but nevermind.", portrait: "resources/bumpy.png" },
                { text: "Carry on.", portrait: "resources/bumpy.png" },
                { text: "He leaves again. Bumpy doesn't seem to understand much about you." },
                { text: "..." },
                { text: "You hear a faint wailing coming from one of the wells." },
                { text: "Upon looking in, everything looks normal." },
                { text: "Strange." },
            ],
        },
        /*"UD-ProjectsUnlocked": {
            ...
            dialogue: [
                { text: "Hey! I have something for you!", portrait: "resources/bumpy.png" },
                { text: "Bumpy holds out an object in his hand. It resembles a card." },
                { text: "Something inside you blurts out..." },
                { text: "A creation of Jacorb's.", portrait: "resources/player.png" },
                { text: "Yes! By the man himself.", portrait: "resources/bumpy.png" },
                { text: "Marcel was telling me about how you've been to the dark universe.", portrait: "resources/bumpy.png" },
                { text: "I believe you could find a piece of his work there: time capsules.", portrait: "resources/bumpy.png" },
                { text: ".", portrait: "resources/player.png" },
            ],
        },
        "UD-TimeCapsuleGained": {
            type: "normal",
            portrait: "resources/secret.png",
            music: "music/bumpy.mp3",
            background: "linear-gradient(135deg, #2e152e 0%, #384038 100%)",
            ...
            dialogue: [
                { text: "Hey! I have something for you!", portrait: "resources/bumpy.png" },
                { text: "Bumpy holds out an object in his hand. It radiates superphysical energy" },
                { text: "A time capsule?", portrait: "resources/player.png" },
                { text: "Um... yeah. ", portrait: "resources/bumpy.png" },
            ],
        },*/
    },
    clickables: {
