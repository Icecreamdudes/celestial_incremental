addLayer("c", {
 ...
 /*       "U2-Tav-End": {
        ...
        "U3-Light-Rift": {
            ...
            dialogue: [
                { text: "You awake in an open field of crimson grass."},
                { text: "You stare into the night sky. There's only a ladder left sitting among uncountable stars."},
                { text: "One more Novasent to go."},
                { text: "Anyways, why the hell are you in this field?"},
                { text: "You realize something is off. Your hands are glowing and translucent."},
                { text: "Kres? Marcel? Nav? Helloooo??? What's happened to me???", portrait: "resources/player.png"},
                { text: "You spot someone else lying down a distance away: a translucent, green being."},
        ...
        "UD-Light-Well-Beta": {
            ...
            dialogue: [
                ...
                { text: "Nevermind, I think we're getting ahead of ourselves. Just keep gathering light for now.", portrait: "resources/bumpy.png" },
        ...
        "UD-Projects-Unlocked": {
            ...
            dialogue: [
                ...
                { text: "Something clicks, and the floor begins to descend." },
                { text: "Woah.", portrait: "resources/player.png" },
                { text: "The walls grow taller and expand outward as you go lower." },
                { text: "They reveal a wide underground chamber full of lights and greenery." },
                { text: "Below us is the Pyramid, the heart of the city.", portrait: "resources/bumpy.png" },
                { text: "A seven-tiered building sitting above the main power generator.", portrait: "resources/bumpy.png" },
                { text: "Do you manage all of this on your own?", portrait: "resources/player.png" },
                { text: "I do, or, kinda not. It's not so simple, you'll see.", portrait: "resources/bumpy.png" },
                { text: "The elevator stops on the pyramid roof." },
                { text: "It's easy to get lost here, so follow me.", portrait: "resources/bumpy.png" },
                { text: "Bumpy takes you down a few flights of stairs and through a few hallways." },
                { text: "[extend]" },
                { text: "You'll see.", portrait: "resources/bumpy.png" },
        ...
        "UD-Light-Well-Gamma": {
            ...
            dialogue: [
                { text: "Alright. We're almost ", portrait: "resources/bumpy.png" },
        ...
        "UD-Blueshift-Project-Start": {
            ...
            dialogue: [
                ...
                { text: "HIII again!", portrait: "resources/bumpy.png" },
                { text: "AHHH!! What the hell!?", portrait: "resources/player.png" },
                { text: "Ha, I'd say the same thing to you if I remembered to tell you to stay out of my stuff.", portrait: "resources/bumpy.png" },
                { text: "...", portrait: "resources/bumpy.png" },
                { text: "Uh, sorry. This is my journal, a place for my most dear of memories.", portrait: "resources/bumpy.png" },
                { text: "One of the few things I have left for myself.", portrait: "resources/bumpy.png" },
                { text: "Are... you going to cry?", portrait: "resources/player.png" },
                { text: "POTENTIALLY! I haven't flipped through this thing in a while.", portrait: "resources/bumpy.png" },
                { text: "There's like... some friends I lost and I don't want to-", portrait: "resources/bumpy.png" },
                ...
                { text: "Ha... thank you.", portrait: "resources/bumpy.png" },
        ...
        "UD-Light-Well-Delta": {
            ...
            dialogue: [
                ...
                { text: "This one is a bit different than the others.", portrait: "resources/bumpy.png" },
                { text: "It pours into the other three, then loops back in on itself.", portrait: "resources/bumpy.png" },
                { text: "It was not built by me, but by one of the other founders of Interspace.", portrait: "resources/bumpy.png" },
                { text: "There were other founders?", portrait: "resources/player.png" },
                { text: "Yes. Once my two best friends.", portrait: "resources/bumpy.png" },
                { text: "Before we fell out, one of them added some shoddy automation all around the city.", portrait: "resources/bumpy.png" },
        ...
        "UD-Light-Well-Delta-Blueshift": {
            ...
            trigger() {return false },
            dialogue: [
                { text: "You're almost ready for your final project. Unfortunately, this well won't be.", portrait: "resources/bumpy.png" },
        ...
        "UD-Starlight-Project-Start": {
            ...
            dialogue: [
                ...
                { text: "It doesn't look like it hurt."},
        ...
        "UD-Cycle-Unlock": {
            ...
            trigger() {return hasUpgrade("bum", 44) && false },
            dialogue: [
                ...
                { text: "I will need you to let go of all of your light before going down.", portrait: "resources/bumpy.png" },
