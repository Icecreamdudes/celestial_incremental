    ...
    cutscenes: {
        ...
        "UD-Start": {
            ...
            dialogue: [
                ...
                { text: "I forgot about that...", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "Marcel pulls out two pairs of glasses from somewhere and hands one to you." },
                { text: "You put them on, but it's still somewhat hard to see here." },
                { text: "Welcome!", portrait: "resources/secret.png" },
                { text: "A human looks into what sounds like a fountain infront of you." },
                ...
                { text: "You look up into the dim-ish night sky. The streetlights in the corners of your vision are still blinding you." },
                { text: "It gets hard to focus on what those two are saying. So, you wait." },
                { text: "You take in your surroundings." },
                { text: "You have been brought to a city. The lights are overwhelmingly bright, but probably normal around here." },
                { text: "The air smells fresh; not what you'd expect in this setting. Take it in." },
                { text: "Take it in! Become one with this universe!", portrait: "resources/secret.png" },
                { text: "I don't blame him. Your city is brilliant.", portrait: "resources/Pets/marcelAcoplaoEvoPet.png" },
                { text: "In more ways than one!", portrait: "resources/player.png" },
                { text: "Your eyes adjust more. You can now see who's teasing you more clearly." },
                { text: "Hi?", portrait: "resources/player.png" },
                { text: "Hi, creation! I'm Bumpy.", portrait: "resources/bumpy.png" },
                { text: "That's a funny name!", portrait: "resources/player.png" },
                { text: "It's an alias. Many developers choose to go by one, much like how you're called the creation.", portrait: "resources/bumpy.png" },
        ...
        "UD-LightRowTwo": {
            ...
            dialogue: [
                { text: "among us.", portrait: "resources/bumpy.png" },
            ],
        },
        "UD-ProjectsUnlocked": {
            type: "normal",
            ...
            dialogue: [
                { text: "big chungus.", portrait: "resources/bumpy.png" },
            ],
        },
        "D1-TimeCapsules": {
            type: "normal",
            ...
            dialogue: [
                { text: "Just like Bumpy said, a new superphysical value appeared during the eclipse: time capsules." },
                { text: "This one has a peculiar aura. It gets into your head." },
                { text: "Superphysical time speeds up all around, but the moon still moves ever slowly." },
                { text: "Our time is limited.", portrait: "resources/humanCere.png" },
                { text: "Someone appeared next to you. They miserably stare into the moon." },
                { text: "I have a very special task for you, Creation.", portrait: "resources/humanCere.png" },
                { text: "Dude, I don't even know your name yet.", portrait: "resources/player.png" },
                { text: "My name?", portrait: "resources/humanCere.png" },
                { text: "...", portrait: "resources/humanCere.png" },
                { text: "...", portrait: "resources/player.png" },
                { text: "...", portrait: "resources/humanCere.png" },
                { text: "My name is ", portrait: "resources/humanCere.png" },
            ],
        },
        ...
        "UD-PrismaticProjectLvl1": {
            ...
            dialogue: [
                { text: "skibidi toilet.", portrait: "resources/bumpy.png" },
            ],
        },
        /*
        "D1-Space-Energy": {
