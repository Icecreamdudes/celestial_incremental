addLayer("p", {
    ...
    clickables: {
        ...
        11: {
            title() { return "<h2>Prestige.<br><small>Req: 100,000 Celestial Points</small>" },
            ...
            style: { border: "3px solid #185e5e", width: '380px', minHeight: '100px', borderRadius: '10px'},
        },
        12: {
    ...
    upgrades: {
        11: {
            ...
            style: { width: '180px', height: '180px', borderColor: "#185e5e", margin: "4px"},
        },
        12: {
            title: "Prestige II",
            unlocked() { return true },
    ...
    microtabs: {
        stuff: {
            "Main": {
                buttonStyle() { return { color: "#30bfbf", borderRadius: "5px" } },
                unlocked() { return true },
                content: [
                    ["blank", "25px"],
                    ["style-column", [
                        ...
                        ["style-column", [
                            ["theme-scroll-column", [
                                ["style-row", [
                                    ["ex-upgrade", 11], ["ex-upgrade", 12], ["ex-upgrade", 13], ["ex-upgrade", 10], ["ex-upgrade", 14],
                                    ["ex-upgrade", 15], ["ex-upgrade", 16], ["ex-upgrade", 17], ["ex-upgrade", 18], ["ex-upgrade", 19],
                                    ["ex-upgrade", 21], ["ex-upgrade", 22], ["ex-upgrade", 23],
                                ]],
                            ], {background: "repeating-linear-gradient(-45deg, var(--layerBackground) 0 15px, var(--menuBackground) 0 30px)", border: "3px solid var(--regBorder)", borderRight: "0", width: "791px", height: "389px", borderRadius: "15px 0 0 15px"}],
                        ], {border: "3px solid #185e5e", borderRadius: "18px 0 0 18px"}],
                    ], {background: "#30bfbf", border: "3px solid #185e5e", borderRadius: "21px 21px 0 21px", width: "800px", padding: "3px"}],
                ]
            },
            "Crystallize": {
                buttonStyle() { return { color: "white", borderRadius: "5px", borderColor: "#30bfbf", backgroundColor: "#98245c"}},
    ...
    tabFormat: [
        ...
        ["row", [
            ["raw-html", () => { return "You have <h3>" + format(player.p.prestigePoints) + "</h3> prestige points." }, {color: "#30bfbf", fontSize: "24px", fontFamily: "monospace"}],
            ["raw-html", () => { return "(+" + format(player.p.prestigePointsToGet) + ")"}, () => {
                let look = {fontSize: "24px", fontFamily: "monospace", marginLeft: "10px"}
                if (player.points.gt(100000)) {look.color = "#30bfbf"} else {look.color = "gray"}
                return look
            }],
        ]],
        ...
        ["row", [
            ["raw-html", () => {return hasUpgrade("p", 12) ? "Boosts celesial points by x" + format(player.p.prestigeEffect) : ""}, {color: "#30bfbf", fontSize: "20px", fontFamily: "monospace"}],
        ...
        ["row", [
            ["raw-html", () => {return hasUpgrade("g", 11) ? "Boosts grass value by x" + format(player.p.prestigeEffect2) : ""}, {color: "#30bfbf", fontSize: "20px", fontFamily: "monospace"}],
        ...
        ["raw-html", "<img src='resources/currencies/prestige_points.png'style='width:40px;height:40px;margin:5px'></img>", {width: "50px", height: "50px", display: "block"}],
