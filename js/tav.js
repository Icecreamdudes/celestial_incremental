addLayer("ta", {
    ...
    update(delta) {
        ...
        if (player.ta.unlockedReverseBreak && !hasMilestone("r", 26)) player.ta.negativeInfinityPointsToGet = Decimal.pow(4, player.ad.antimatter.div(1e308).add(1).log(1e308)).mul(8)
        if (player.ta.unlockedReverseBreak && hasMilestone("r", 26)) player.ta.negativeInfinityPointsToGet = Decimal.pow(8, player.ad.antimatter.div(1e308).add(1).log(1e308)).mul(8)
